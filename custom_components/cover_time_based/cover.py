...
CONF_IS_BUTTON_TIME = "is_button_time"
...
SWITCH_COVER_SCHEMA = {
    **BASE_DEVICE_SCHEMA,
    ...
    vol.Optional(CONF_IS_BUTTON_TIME, defaut=1): cv.positive_int,
    **TRAVEL_TIME_SCHEMA,
}
...
def devices_from_config(domain_config):
    ...
    for device_id, config in domain_config[CONF_DEVICES].items():
        ...
        is_button_time = config.pop(CONF_IS_BUTTON_TIME) if CONF_IS_BUTTON_TIME in config else 1
...
class CoverTimeBased(CoverEntity, RestoreEntity):
    def __init__(
        ...
        self._is_button_time = is_button_time
        ...
        if command == SERVICE_CLOSE_COVER:
            ...
            if self._cover_entity_id is not None:
                ...
                if self._is_button:
                    ...
                    await sleep(self._is_button_time)
